...
<head>
  ...
  <script type="text/javascript">
    ...
    function loadOperation(operation) {
      ...
      var input = currentService.api.operations[operation].input.members;
      $('#operationData').val(JSON.stringify(input, null, 2));
    }
    ...
    function loadServices() {
      ...
      for (var key in AWS) {
        ...
        if (AWS[key].prototype.constructor.__super__.name === 'Service') {
          ...
          var fullName = svc.api.serviceAbbreviation || svc.api.serviceFullName;
    ...
    function executeOperation() {
      var params = JSON.parse($('#operationData').val() || '{}');
...
<body>
    ...
    window.onAmazonLoginReady = function() {
      ...
      $('#login-amazon').click(function() {
        amazon.Login.authorize({scope: 'profile'}, function(response) {
          if (!response.error) {
            loadIDPCredentials('www.amazon.com',
              window.appInfo.amazon.roleArn,
  ...
  <script type="text/javascript">
   ...
   function loginToGoogle(response) {
     if (!response.error) {
       loadIDPCredentials(null, window.appInfo.google.roleArn, response.id_token);
     }
   }
  </script>
